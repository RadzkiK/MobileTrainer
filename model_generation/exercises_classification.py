# -*- coding: utf-8 -*-
"""exercises_classification.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_9kMRvUdi-8idIajy0BZtTQA0VFzx52G
...
class MoveNetPreprocessor(object):
  ...
  def process(self, per_pose_class_limit=None, detection_threshold=0.05):
  ...
  def _all_landmarks_as_dataframe(self):
    ...
    for class_index, class_name in enumerate(self._pose_class_names):
      csv_out_path = os.path.join(self._csvs_out_folder_per_class,
                                  class_name + '.csv')
      per_class_df = pd.read_csv(csv_out_path, header=None, encoding="latin-1")
...
if use_custom_dataset:
  ...
  #!unzip -q exercisesPoses2.zip
  dataset_in = 'exercises_poses_side'
...
if not is_skip_step_1:
  ...
  images_out_train_folder = 'poses_side_images_out_train'
  csvs_out_train_path = 'side_train_data.csv'
...
if not is_skip_step_1:
  ...
  images_out_test_folder = 'poses_side_images_out_test'
  csvs_out_test_path = 'side_test_data.csv'
...
plt.savefig("incorrectly_predidcted.png")
plt.show()
...
#!zip -r poses_images_out.zip poses_images_out_test poses_images_out_train

#!zip exercisesPoses2_classifier.zip exercisesPoses2_labels.txt exercisesPoses2_classifier.tflite

df_test_out = df_test.copy()

df_test_out["class_pred"] = y_pred_label
y_pred_score = np.max(y_pred, axis=1)
df_test_out["class_pred_score"] = y_pred_score

df_test_out.to_csv("person_keras.csv")